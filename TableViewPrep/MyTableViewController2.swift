...
class MyTableViewController2: UITableViewController {
    ...
    var items = ["Peter", "Food", "vacation", "sleep", "work"]
    var name = ""
    var text = ""
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tableView.register(UITableViewCell.self, forCellReuseIdentifier: "mycell2")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = name + " and " + items[indexPath.row]
        return cell
    }
